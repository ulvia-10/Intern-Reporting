...
class C_data extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('server_admin/tables', $data);
    ...
    public function indexuser()
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('server_admin/tables_user', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function detail($id)
    {
        ...
        $this->load->view('templates/sidebar', $data);
        $this->load->view('templates/topbar', $data);
        $this->load->view('server_admin/detailkondisi', $data);
        $this->load->view('templates/footer');
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('templates/sidebar', $data);
            $this->load->view('templates/topbar', $data);
            $this->load->view('server_admin/editkondisi', $data);
            $this->load->view('templates/footer');
        } else {
            // #code...
